$(document).ready(function () {      
    ...
    function init_template(){//Class is vital to run AJAX Pages 
        ...
        var landing_positive = $('.landing-menu').height() + 400;
        var landing_negative = landing_positive * (-1);
        
        $('.landing-remove').click(function(){
            $('.landing-menu').css({
                "transform": "translateY("+landing_negative+"px)", 
                "-webkit-transform": "translateY("+landing_negative+"px)", 
                "-moz-transform": "translateY("+landing_negative+"px)", 
                "-o-transform": "translateY("+landing_negative+"px)",
                "-ms-transform": "ranslateY("+landing_negative+"px)"
            });
        });            
    
        $('.landing-deploy').click(function(){
            $('.landing-menu').css({
                "transform": "translateY("+0+"px)", 
                "-webkit-transform": "translateY("+0+"px)", 
                "-moz-transform": "translateY("+0+"px)", 
                "-o-transform": "translateY("+0+"px)",
                "-ms-transform": "ranslateY("+0+"px)"
            });
        });
      ...
      var options = {
        ...
        onStart: {
          ...
          render: function ($container) {
            ...
            var landing_positive = $('.landing-menu').height();
            var landing_negative = landing_positive * (-1);
